...
public:
  ...
  void PrintVector(std::vector<std::string> &vec, int fontType, int posX, int posY, int red, int green, int blue, int alpha);  
  void PrintVector(std::vector<float> &vec, int fontType, int posX, int posY, int red, int green, int blue, int alpha);
  ...
  //2D sprite rendering
  void RenderSprite(GRAPHIC_IMAGE gi, int positionX, int positionY, int red, int green, int blue);
