...
//*****************************************************************************
void CGraphics::RenderSprite(GRAPHIC_IMAGE gi, int positionX, int positionY, int red, int green, int blue){
  CLog *pLog = CLog::Instance();
  if(gi.bValid == false)
    return;
...
void CGraphics::PrintVector(std::vector<std::string> &vec, int fontType, int posX, int posY, int red, int green, int blue, int alpha){
...
void CGraphics::PrintVector(std::vector<float> &vec, int fontType, int posX, int posY, int red, int green, int blue, int alpha){
